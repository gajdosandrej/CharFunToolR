...
plotGraf(function(t)
  cf_LogRV_FisherSnedecor(t, df1, df2, weight), t, title = "Characteristic function of a linear combination of log-F RVs")
...
df1 <- 5
df2 <- 3
cf <- function(t) cf_LogRV_FisherSnedecor(t, df1, df2, weight)
options <- list()
options$N <- 2^12
