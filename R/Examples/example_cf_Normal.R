...
mu <- seq(from = -3,to = 3,length.out = 50)
sigma <- seq(from = 0.1,to = 1.5,length.out = 50)
t <- seq(from = -100,to = 100,length.out = 2001)
plotGraf(function(t)
  cf_Normal(t,mu,sigma,coef), t, title = "Characteristic function of the linear combination of Normal RVs")
...
sigma <- seq(from = 0.1,to = 1.5,length.out = 50)
coef <- 1/(((1:50) - 0.5)*pi)^2
cf <- function(t) cf_Normal(t,mu,sigma,coef)
options <- list()
options$N <- 2^10
